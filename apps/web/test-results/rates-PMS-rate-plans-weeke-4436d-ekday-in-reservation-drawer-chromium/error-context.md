...
- Name: rates.spec.ts >> PMS rate plans >> weekend stay quotes higher total than weekday in reservation drawer
- Location: e2e/rates.spec.ts:57:7
...
Call log:
  - navigating to "http://localhost:3000/pms", waiting until "load"
