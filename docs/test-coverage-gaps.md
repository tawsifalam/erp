...
| API integration (2-org PostgreSQL) | ✅ | `RUN_INTEGRATION=1 pnpm --filter @erp/api test:integration` — 22 cases |
| Mock E2E isolation | ✅ | `e2e/tenant-isolation.spec.ts` (org + branch guards, mutations, admin routes, notifications/reporting/fiscal/join) |
